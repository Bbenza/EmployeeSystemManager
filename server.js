...
updateEmployee = () => {
  connection.query(
    "SELECT * FROM role, employee WHERE roles.id = employee.role_id",
    function(err, res) {
      if (err) throw err;
      inquirer
        .prompt([
        ...
        .then(function(answer) {
          ...
          //creates seperate constiables for employee first and last name by splitting the array:in the table, first and last name are seperate columns.
